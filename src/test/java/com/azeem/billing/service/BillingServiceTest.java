...
class BillingServiceTest {
    ...
    void getAllRecords_shouldLoadDataAndReturnRecords() {
        ...
        assertEquals("CA", result.get(0).state());
    ...
    void getAllRecordsTwice_shouldLoadDataOnce() {
        ...
        assertEquals("CA", result1.get(0).state());

        assertEquals(1, result2.size());
        assertEquals("CA", result2.get(0).state());
    ...
    void generateSummary_test() {
        ...
        assertEquals("S3", result.getHighestChargeRecord().senatorId());
