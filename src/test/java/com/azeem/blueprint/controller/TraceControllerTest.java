...
//
//  @MockitoBean private AiExecutionGateway aiExecutionGateway;
...
//
//    when(aiExecutionGateway.ask(eq("testing"), any(UUID.class), eq("2026-01")))
...
//
//    verify(aiExecutionGateway)
//        .ask(eq(request.getPrompt()), any(UUID.class), eq(request.getCurrentPeriod()));
//  }
// }
